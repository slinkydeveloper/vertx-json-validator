...
public class TypeValidatorFactory implements ValidatorFactory {
    ...
    private static JsonSchemaType parseType(String type, String format, JsonObject schema) {
        switch (type) {
            ...
            case "number": return (format != null && (format.equals("double") || format.equals("float"))) ? JsonSchemaType.NUMBER_DECIMAL : JsonSchemaType.NUMBER;
            ...
            default: throw SchemaErrorType.WRONG_KEYWORD_VALUE.createException(schema, "Unknown type: " + type);
        }
    }
